    ...
    >
      ...
      <Form onSubmit={handleSubmit}>
        <Row className="mb-3">
          ...
          <Form.Group as={Col} md="4">
            <Form.Label style={{ color: '#00BFFF' }}>Full Address</Form.Label>
            <InputGroup hasValidation>
              <Form.Control
                type="text"
                placeholder="Address"
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="6">
            <Form.Label style={{ color: '#00BFFF' }}>Property Images</Form.Label>
            <Form.Control
              type="file"
              placeholder="images"
              required
          ...
          <Form.Group as={Col} md="3">
            <Form.Label style={{ color: '#00BFFF' }}>Owner Contact</Form.Label>
            <Form.Control
              type="tel"
