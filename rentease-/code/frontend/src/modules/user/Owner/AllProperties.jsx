...
const AllProperties = () => {
  ...
  return (
    <div style={{ backgroundColor: '#f0faff', padding: '30px', minHeight: '100vh' }}>
      <h3 style={{ color: '#00BFFF', fontWeight: 'bold', textAlign: 'center', marginBottom: '25px' }}>
        All Properties
      </h3>
              ...
              >
                ...
                <TableCell align="center">
                  <Button
                    ...
                    style={{ fontWeight: 'bold', color: '#00BFFF', borderColor: '#00BFFF' }}
                  ...
                  <Modal show={show && editingPropertyId === property._id} onHide={handleClose}>
                    <Modal.Header closeButton>
                      <Modal.Title style={{ color: '#00BFFF' }}>Edit Property</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                      <Form onSubmit={(e) => { e.preventDefault(); saveChanges(property._id); }}>
                        <Row className="mb-3">
                          <Form.Group as={Col} md="4">
                            <Form.Label style={{ color: '#00BFFF' }}>Property Type</Form.Label>
                            <Form.Select
                              name="propertyType"
                              value={editingPropertyData.propertyType}
                              onChange={handleChange}
                          ...
                          <Form.Group as={Col} md="4">
                            <Form.Label style={{ color: '#00BFFF' }}>Ad Type</Form.Label>
                            <Form.Select
                              name="propertyAdType"
                          ...
                          <Form.Group as={Col} md="4">
                            <Form.Label style={{ color: '#00BFFF' }}>Address</Form.Label>
                            <InputGroup hasValidation>
                              <Form.Control
                                type="text"
                                name="propertyAddress"
                        ...
                        <Row className="mb-3">
                          <Form.Group as={Col} md="6">
                            <Form.Label style={{ color: '#00BFFF' }}>Image</Form.Label>
                            <Form.Control
                              type="file"
                              name="image"
                              accept="image/*"
                          ...
                          <Form.Group as={Col} md="3">
                            <Form.Label style={{ color: '#00BFFF' }}>Contact</Form.Label>
                            <Form.Control
                              type="tel"
                              name="ownerContact"
                              value={editingPropertyData.ownerContact}
                          ...
                          <Form.Group as={Col} md="3">
                            <Form.Label style={{ color: '#00BFFF' }}>Amount</Form.Label>
                            <Form.Control
                              type="number"
                              name="propertyAmt"
                              value={editingPropertyData.propertyAmt}
